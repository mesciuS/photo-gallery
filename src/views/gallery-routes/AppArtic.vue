<script>
import { articImages } from '../../store.js'
export default {
    name: 'AppArtic',
    data() {
        return {
            imagePaths: articImages,
    ...
    <div id="gallery-view-wrapper">
        ...
        <div id="gallery-view">
            <div class="view-img" v-for="(image, index) in imagePaths" :key="index">
                <img :src="image" alt="artic vibes" class="view-img-inner" @click="openModal(index)" data-bs-toggle="modal" data-bs-target="#exampleModal">
            </div>
        </div>
